...
<html lang="en">
  <head>
    ...
    <title>Program - Lingkar Pendidikan</title>
      ...
      <div class="container">
        <center>
          ...
          <div class="row align-items-center">
            <div class="col-12">
              <p class="lead">
                Program Lingkar Pendidikan terdiri dari dua layanan utama, yaitu Try Out dan Webinar, yang dirancang untuk menunjang kesiapan akademik dan mental siswa.
                Try Out memberikan simulasi ujian secara berkala yang menyerupai ujian sesungguhnya, lengkap dengan sistem penilaian dan analisis hasil untuk mengukur kemampuan siswa.
                Sementara itu, Webinar menghadirkan sesi interaktif bersama mentor dan narasumber ahli, membahas strategi belajar, motivasi, serta informasi penting seputar pendidikan tinggi dan sekolah kedinasan.
                Kedua program ini bertujuan memberikan pengalaman belajar yang komprehensif dan inspiratif.
              </p>
            </div>
          </div>
          ...
          <div class="row align-items-center">
            <div class="col-6">
              ...
              <a id="button-hero" class="btn btn-primary btn-lg" href="tryout.php" role="button">Selengkapnya</a>
            </div>
            <br /><br />
            ...
            <div class="col-6">
              ...
              <a id="button-hero" class="btn btn-primary btn-lg" href="webinar.php" role="button">Selengkapnya</a>
            </div>
          </div>
        </center>
      </div>
