...
<html lang="en">
  <head>
    ...
    <title>Tentang Kami - Lingkar Pendidikan</title>
  ...
  <body>
    ...
    <!-- TENTANG KAMI -->
    <section style="background-color: #ffffff" id="tentang-kami">
      <div class="container">
        <center>
        ...
        <center>
          <div class="row align-items-center">
            <div class="col-12">
              <h3 style="color: #050c9c; font-size: 30px"><b>Visi Misi</b></h3>
              <h4>Visi</h4>
              <p class="lead">1. Mewujudkan generasi muda bangsa yang unggul, kreatif, dan inovatif</p>
              <p class="lead">2. Mewujudkan harmonisasi kerja di lingkungan Lingkar Pendidikan dan sekitarnya</p>
              <br />

              <h4>Misi</h4>
              <p class="lead">1. Membantu generasi muda bangsa untuk bisa masuk dan melanjutkan pendidikan di kampus impiannya</p>
              <p class="lead">2. Menjembatani generasi muda bangsa agar bisa mewujudkan cita-citanya dengan berbekal ilmu pengetahuan</p>
            </div>
          </div>
        </center>
      </div>
