...
<html lang="en">
  <head>
    ...
    <title>Kelas Perguruan Tinggi - Lingkar Pendidikan</title>
      ...
      <div class="container">
        <center>
          <h2 style="font-size: 40px">
            <b><span style="color: #050c9c">Kelas Perguruan Tinggi</span></b>
          </h2>
          <br />
          ...
          <div class="row align-items-center">
            <div class="col-12">
              <p class="lead">
                Fokus Kelas Perguruan Tinggi dirancang khusus untuk membantu siswa mempersiapkan diri menghadapi ujian masuk perguruan tinggi negeri maupun swasta dengan lebih terarah.
                Program ini mencakup sesi bimbingan intensif bersama mentor berpengalaman, disertai dengan buku pegangan dan materi belajar yang lengkap serta terkini.
                Setiap sesi dirancang interaktif dan terstruktur untuk memperkuat pemahaman konsep dasar hingga strategi menjawab soal dengan tepat.
              </p>
            </div>
          </div>
        </center>
          ...
          <!-- BUKU WANGSIT -->
            <div class="row align-items-center">
                <div class="col-6 text-center">
                    <img id="gambar-buku" src="../Materi/wangsit_ptnSaintek.png" alt="Wangsit SAINTEK" />
                    <h4 style="margin-bottom: 12px;">Buku Wangsit SAINTEK</h4>
                    <a class="btn-download" href="../Materi/wangsit_saintek.pdf">Download</a>
                </div>

                <br />
                
                <div class="col-6 text-center">
                    <img id="gambar-buku" src="../Materi/wangsit_ptnSoshum.png" alt="Wangsit SOSHUM" />
                    <h4 style="margin-bottom: 12px;">Buku Wangsit SOSHUM</h4>
                    <a class="btn-download" href="../Materi/wangsit_soshum.pdf">Download</a>
                </div>
            </div>
            ...
            <div class="row align-items-center">
                <div class="col-6 text-center">
                    <img id="gambar-buku" src="../Materi/top_ptnSaintek.png" alt="TOP ONE SAINTEK" />
                    <h4 style="margin-bottom: 12px;">Buku TOP SAINTEK</h4>
                    <a class="btn-download" href="../Materi/top_saintek.pdf">Download</a>
                </div>

                <br />
                
                <div class="col-6 text-center">
                    <img id="gambar-buku" src="../Materi/top_ptnSoshum.png" alt="TOP ONE SOSHUM" />
                    <h4 style="margin-bottom: 12px;">Buku TOP SOSHUM</h4>
                    <a class="btn-download" href="../Materi/top_soshum.pdf">Download</a>
                </div>
          </div>
      </div>
    </section>
